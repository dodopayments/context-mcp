...
Supports **Pinecone** and **Qdrant**. Your embeddings are stored here.
...
vectordb:
  provider: qdrant
  indexName: my-docs # Used as the Qdrant collection name
  qdrant:
    url: http://localhost:6333 # or set QDRANT_URL env var
```

| Provider   | Required env vars                            |
| ---------- | -------------------------------------------- |
| `pinecone` | `PINECONE_API_KEY`                           |
| `qdrant`   | `QDRANT_URL` (or config), `QDRANT_API_KEY` (cloud only) |
